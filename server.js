...
var template=`
				...
				<div id="container">
					...
					<div id="body" class="width">
						...
						<h4>ADD COMMENTS</h4>
						<form>
						<p><label for="message">Your comment:</label></p>
								   <p> <textarea cols="45" rows="7" name="message" id="message"></textarea></p>
									<p><input name="send" style="margin-left: 150px;" class="formbutton" value="POST COMMENT" type="submit" /></p>
